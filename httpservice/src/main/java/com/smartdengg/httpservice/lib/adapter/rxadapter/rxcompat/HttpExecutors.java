...
public class HttpExecutors {
  ...
  private static final BlockingQueue<Runnable> taskPoolWaitQueue = new PriorityBlockingQueue<>(128);
  private static final ThreadFactory taskThreadFactory = new ThreadFactory() {
  ...
  static {
    eventExecutor =
        new ThreadPoolExecutor(CORE_POOL_SIZE, MAXIMUM_POOL_SIZE, KEEP_ALIVE, TimeUnit.SECONDS,
            taskPoolWaitQueue, taskThreadFactory, rejectedHandler);
  }
