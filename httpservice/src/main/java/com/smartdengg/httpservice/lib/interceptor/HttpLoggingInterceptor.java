...
public class HttpLoggingInterceptor implements Interceptor {
    ...
    public static final char HORIZONTAL_DOUBLE_LINE_SINGLE = '│';
    private static final String DOUBLE_DIVIDER = "════════════════════════════════════════════";
    private static final String SINGLE_DIVIDER = "────────────────────────────────────────────";

    public static final String TOP_BORDER = TOP_LEFT_CORNER + DOUBLE_DIVIDER + DOUBLE_DIVIDER;
    public static final String TOP_BORDER_SINGE = TOP_LEFT_CORNER_SINGLE + SINGLE_DIVIDER + SINGLE_DIVIDER;
    public static final String BOTTOM_BORDER = BOTTOM_LEFT_CORNER + DOUBLE_DIVIDER + DOUBLE_DIVIDER;
    public static final String BOTTOM_BORDER_SINGLE = BOTTOM_LEFT_CORNER_SINGLE + SINGLE_DIVIDER + SINGLE_DIVIDER;
        ...
        public void log(String message) {
            for (int i = 0, length = message.length(); i < length; i++) {
                ...
                do {
                    ...
                    Log.d(HttpService.getHttpTAG(), HttpLoggingInterceptor.HORIZONTAL_DOUBLE_LINE + message.substring(i, end));
                    i = end;
                } while (i < newline);
            }
        }
    ...
    public static HttpLoggingInterceptor createLoggingInterceptor(List<String> exRequestHeaders, List<String> exResponseHeaders) {
        ...
        if (logHeaders) {
            ...
            if (!logBody || !hasRequestBody) {
                ...
                if (contentType != null) {
                    ...
                    if (requestBody.contentLength() > 0 && type != null && ("text".equals(type) || "application".equals(type))) {
